...
T = TypeVar("T", bound="RoleAssignmentWrite")


@_attrs_define
class RoleAssignmentWrite:
    """
    Attributes:
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_assignment_write.additional_properties = d
        return role_assignment_write
