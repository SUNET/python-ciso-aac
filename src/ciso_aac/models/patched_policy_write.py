...
T = TypeVar("T", bound="PatchedPolicyWrite")


@_attrs_define
class PatchedPolicyWrite:
    """
    Attributes:
        id (Union[Unset, UUID]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_policy_write.additional_properties = d
        return patched_policy_write
