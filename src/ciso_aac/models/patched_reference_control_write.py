...
T = TypeVar("T", bound="PatchedReferenceControlWrite")


@_attrs_define
class PatchedReferenceControlWrite:
    """
    Attributes:
        id (Union[Unset, UUID]):
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        typical_evidence = (
            self.typical_evidence
            if isinstance(self.typical_evidence, Unset)
            else (None, str(self.typical_evidence).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_reference_control_write = cls(
            id=id,
        ...
        patched_reference_control_write.additional_properties = d
        return patched_reference_control_write
