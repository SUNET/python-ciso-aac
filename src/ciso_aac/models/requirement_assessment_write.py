...
T = TypeVar("T", bound="RequirementAssessmentWrite")


@_attrs_define
class RequirementAssessmentWrite:
    """
    Attributes:
        id (UUID):
        created_at (datetime.datetime):
        updated_at (datetime.datetime):
        compliance_assessment (UUID):
        requirement (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        compliance_assessment = UUID(d.pop("compliance_assessment"))

        requirement = UUID(d.pop("requirement"))
        ...
        requirement_assessment_write = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            compliance_assessment=compliance_assessment,
        ...
        requirement_assessment_write.additional_properties = d
        return requirement_assessment_write
