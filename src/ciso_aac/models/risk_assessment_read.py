...
T = TypeVar("T", bound="RiskAssessmentRead")


@_attrs_define
class RiskAssessmentRead:
    """
    Attributes:
        id (UUID):
        perimeter (str):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        risk_scenarios_count = self.risk_scenarios_count
        ...
        field_dict.update(
            {
                ...
                "risk_scenarios_count": risk_scenarios_count,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        risk_scenarios_count = d.pop("risk_scenarios_count")
        ...
        risk_assessment_read.additional_properties = d
        return risk_assessment_read
