...
T = TypeVar("T", bound="RiskMatrixWrite")


@_attrs_define
class RiskMatrixWrite:
    """
    Attributes:
        id (UUID):
        name (str):
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        json_definition = (None, str(self.json_definition).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        risk_matrix_write.additional_properties = d
        return risk_matrix_write
