...
T = TypeVar("T", bound="FindingsAssessmentWrite")


@_attrs_define
class FindingsAssessmentWrite:
    """
    Attributes:
        id (UUID):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        findings_assessment_write.additional_properties = d
        return findings_assessment_write
