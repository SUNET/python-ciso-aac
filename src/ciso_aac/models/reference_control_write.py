...
T = TypeVar("T", bound="ReferenceControlWrite")


@_attrs_define
class ReferenceControlWrite:
    """
    Attributes:
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reference_control_write.additional_properties = d
        return reference_control_write
