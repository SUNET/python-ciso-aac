...
T = TypeVar("T", bound="PatchedFolderWrite")


@_attrs_define
class PatchedFolderWrite:
    """
    Attributes:
        id (Union[Unset, UUID]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_folder_write.additional_properties = d
        return patched_folder_write
