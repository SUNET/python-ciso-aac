...
T = TypeVar("T", bound="RiskScenarioWrite")


@_attrs_define
class RiskScenarioWrite:
    """
    Attributes:
        id (UUID):
        risk_matrix (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        risk_assessment = UUID(d.pop("risk_assessment"))
        ...
        risk_scenario_write.additional_properties = d
        return risk_scenario_write
