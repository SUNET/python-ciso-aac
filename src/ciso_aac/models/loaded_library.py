...
T = TypeVar("T", bound="LoadedLibrary")
...
class LoadedLibrary:
    ...
    Attributes:
        ...
        urn (Union[None, str]):
        version (int):
        reference_count (int): Returns the number of distinct dependent libraries and risk and compliance assessments
            that reference objects from this library
        locales (list[Any]):
        has_update (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reference_count = d.pop("reference_count")
        ...
        loaded_library.additional_properties = d
