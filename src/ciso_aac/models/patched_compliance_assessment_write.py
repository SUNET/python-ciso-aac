...
T = TypeVar("T", bound="PatchedComplianceAssessmentWrite")


@_attrs_define
class PatchedComplianceAssessmentWrite:
    """
    Attributes:
        id (Union[Unset, UUID]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_compliance_assessment_write = cls(
            id=id,
            baseline=baseline,
        ...
        patched_compliance_assessment_write.additional_properties = d
        return patched_compliance_assessment_write
