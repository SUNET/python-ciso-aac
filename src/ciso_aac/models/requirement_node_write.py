...
T = TypeVar("T", bound="RequirementNodeWrite")


@_attrs_define
class RequirementNodeWrite:
    """
    Attributes:
        id (UUID):
        name (str):
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        display_short = (None, str(self.display_short).encode(), "text/plain")

        display_long = (None, str(self.display_long).encode(), "text/plain")

        created_at = self.created_at.isoformat().encode()

        updated_at = self.updated_at.isoformat().encode()

        assessable = (None, str(self.assessable).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requirement_node_write.additional_properties = d
        return requirement_node_write
