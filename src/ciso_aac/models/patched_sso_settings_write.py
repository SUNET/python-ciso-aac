...
T = TypeVar("T", bound="PatchedSSOSettingsWrite")


@_attrs_define
class PatchedSSOSettingsWrite:
    """
    Attributes:
        id (Union[Unset, UUID]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_sso_settings_write = cls(
            id=id,
        ...
        patched_sso_settings_write.additional_properties = d
        return patched_sso_settings_write
