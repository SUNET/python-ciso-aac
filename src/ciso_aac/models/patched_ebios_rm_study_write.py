...
T = TypeVar("T", bound="PatchedEbiosRMStudyWrite")


@_attrs_define
class PatchedEbiosRMStudyWrite:
    """
    Attributes:
        id (Union[Unset, UUID]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_ebios_rm_study_write = cls(
            id=id,
        ...
        patched_ebios_rm_study_write.additional_properties = d
        return patched_ebios_rm_study_write
