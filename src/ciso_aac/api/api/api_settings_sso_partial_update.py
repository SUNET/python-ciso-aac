...
from ...models.patched_sso_settings_write import PatchedSSOSettingsWrite
from ...models.sso_settings_write import SSOSettingsWrite
...
def _get_kwargs(
    *,
    ...
    if isinstance(body, PatchedSSOSettingsWrite):
