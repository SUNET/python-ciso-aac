...
from ...models.patched_solution_write import PatchedSolutionWrite
from ...models.solution_write import SolutionWrite
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedSolutionWrite):
