...
from ...models.patched_global_settings import PatchedGlobalSettings
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/settings/global/{id}/",
    }

    if isinstance(body, PatchedGlobalSettings):
