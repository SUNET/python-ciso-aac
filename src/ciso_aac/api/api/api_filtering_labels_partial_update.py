...
from ...models.filtering_label_write import FilteringLabelWrite
from ...models.patched_filtering_label_write import PatchedFilteringLabelWrite
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedFilteringLabelWrite | PatchedFilteringLabelWrite | PatchedFilteringLabelWrite,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedFilteringLabelWrite):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PatchedFilteringLabelWrite):
        body (PatchedFilteringLabelWrite):
        body (PatchedFilteringLabelWrite):
