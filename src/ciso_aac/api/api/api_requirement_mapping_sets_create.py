...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/requirement-mapping-sets/",
    }

    if isinstance(body, RequirementMappingSetWrite):
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = RequirementMappingSetWrite.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """
    Args:
        body (RequirementMappingSetWrite):
        body (RequirementMappingSetWrite):
        body (RequirementMappingSetWrite):
