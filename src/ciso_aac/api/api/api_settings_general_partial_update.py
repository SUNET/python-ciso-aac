...
from ...models.patched_general_settings import PatchedGeneralSettings
from ...types import Response


def _get_kwargs(
    *,
    body: PatchedGeneralSettings | PatchedGeneralSettings | PatchedGeneralSettings,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedGeneralSettings):
