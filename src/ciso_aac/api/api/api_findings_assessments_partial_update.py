...
from ...models.patched_findings_assessment_write import PatchedFindingsAssessmentWrite
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedFindingsAssessmentWrite):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PatchedFindingsAssessmentWrite):
        body (PatchedFindingsAssessmentWrite):
        body (PatchedFindingsAssessmentWrite):
