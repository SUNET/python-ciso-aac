...
from ...models.entity_write import EntityWrite
from ...models.patched_entity_write import PatchedEntityWrite
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedEntityWrite | PatchedEntityWrite | PatchedEntityWrite,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedEntityWrite):
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> EntityWrite | None:
    if response.status_code == 200:
        response_200 = EntityWrite.from_dict(response.json())
