...
from ...models.patched_role_write import PatchedRoleWrite
from ...models.role_write import RoleWrite
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedRoleWrite | PatchedRoleWrite | PatchedRoleWrite,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedRoleWrite):
