...
from ...models.patched_security_exception_write import PatchedSecurityExceptionWrite
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedSecurityExceptionWrite | PatchedSecurityExceptionWrite | PatchedSecurityExceptionWrite,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedSecurityExceptionWrite):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PatchedSecurityExceptionWrite):
        body (PatchedSecurityExceptionWrite):
        body (PatchedSecurityExceptionWrite):
